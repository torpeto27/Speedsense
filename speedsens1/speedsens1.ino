...
unsigned long t1=0;
unsigned long t2=0; 
unsigned long maxMicroSec=1000; // Timeout in ms between sensors
unsigned long minMicroSec=15; // Minimum time in ms (reasonable velocity)
float velocity=0;
float dtime=0;
